  ...
  return (
    <div className="hero-section">
      <img
        ...
        src="/images/blured-bag-left-hero.png"
        alt="blured bag for left bottom corner of hero section"
      />
      <img className="hero-image" src="/images/girl-hero-section.png" alt="" />
      <div className="hero-desc">
        <h1 className="hero-title">
          <img src="/detox-hero.svg" alt="Detox svg for hero section" />
        </h1>
      ...
      <div className="scroll-down-container">
        <img src="/images/scroll-down-arrows.svg" alt="scroll down images" />
        <p className="scroll-text">learn more</p>
        <img
          className="scroll-bag"
          src="/images/scroll-down-bag.png"
          alt="scroll down bag image"
        />
      </div>
      <img
        className="blr-right-bag"
        src="/images/blured-bag-right-hero.png"
